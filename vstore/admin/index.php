...
session_start();
//koneksi ke database
// $koneksi = new mysqli("localhost","root","","vk");
include "../koneksi.php";
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand"1d href="index.php">MUMER</a>
            </div>
...
font-size: 16px;"> <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <a href="index.php?halaman=provinsi"><i class="fa fa-dashboard fa-3x"></i> Provinsi</a>
        ...
        <div id="page-wrapper" >
            ...
            if (isset($_GET['halaman']))
            {
              ...
              {
                include 'hapusprovinsi.php';
              }
              elseif ($_GET['halaman']== "tambahprovinsi")
              {
                include 'tambahprovinsi.php';
              }
            }
            else {
              include 'home.php';
